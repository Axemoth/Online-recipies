...
namespace OnlineFoodReceipe.Models
{
    public class MenuDal
    {
        ...
        {
            string str = "INSERT INTO Receipe (RName, Image, Youtube, Ingredient, HTM, RoleID, SName, VNB, UserId) VALUES (@rname, @image, @youtube, @ingredient, @htm, @roleid, @sname, @vnb, @id)";
            cmd = new SqlCommand(str, con);
            con.Open();
